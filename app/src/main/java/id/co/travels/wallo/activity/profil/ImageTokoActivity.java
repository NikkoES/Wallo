...
public class ImageTokoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_image_toko);
        ButterKnife.bind(this);

        initToolbar();
    }

    @OnClick({R.id.btn_ambil_foto, R.id.btn_simpan})
    ...
    private void setToImageView(Bitmap bmp) {
        ...
        imageToko.setImageBitmap(decoded);
    }
    ...
    private void initToolbar() {
        ...
        getSupportActionBar().setTitle("Foto Toko");
    }
